                            ...
                            <div class="card em-card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            {{ Form::label('shift_type', __('Select Shift Type'), ['class' => 'form-label']) }}<x-required></x-required>
                                            {{ Form::select('shift_type', $shiftType, null, ['class' => 'form-control', 'shift_type' => 'shift_type', 'required' => 'required', 'placeholder' => __('Select Shift Type')]) }}
                                        </div>
