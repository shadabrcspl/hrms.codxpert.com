            ...
            <div class="card mb-0 h-100">
                <div class="card-header card-body">
                    ...
                    <div class="row text-xs">
                        ...
                        @elseif($emailTemplate->slug == 'new_complaint')
                            <div class="row">
                                <p class="col-6">{{ __('Company Name') }} : <span
                                        class="pull-right text-primary">{company_name}</span></p>
                                <p class="col-6">{{ __('Complaint From Name') }} : <span
                                        class="pull-right text-primary">{complaint_from_name}</span></p>
                                <p class="col-6">{{ __('Complaint Against Name') }} : <span
                                        class="pull-right text-primary">{complaint_against_name}</span></p>
                                <p class="col-6">{{ __('Complaint Title') }} : <span
                                        class="pull-right text-primary">{complaint_title}</span></p>
                                <p class="col-6">{{ __('Complaint Detail') }} : <span
                                        class="pull-right text-primary">{complaint_detail}</span></p>
                                <p class="col-6">{{ __('Complaint Date') }} : <span
                                        class="pull-right text-primary">{complaint_date}</span></p>
                            </div>
                        @elseif($emailTemplate->slug == 'new_warning')
                            <div class="row">
                                <p class="col-6">{{ __('Company Name') }} : <span
                                        class="pull-right text-primary">{company_name}</span></p>
                                <p class="col-6">{{ __('Warning By') }} : <span
                                        class="pull-right text-primary">{warning_by}</span></p>
                                <p class="col-6">{{ __('Warning To') }} : <span
                                        class="pull-right text-primary">{warning_to}</span></p>
                                <p class="col-6">{{ __('Warning Subject') }} : <span
                                        class="pull-right text-primary">{warning_subject}</span></p>
                                <p class="col-6">{{ __('Warning Detail') }} : <span
                                        class="pull-right text-primary">{warning_detail}</span></p>
                                <p class="col-6">{{ __('Warning Date') }} : <span
                                        class="pull-right text-primary">{warning_date}</span></p>
                            </div>
                        @endif
                    </div>
                </div>
