...
<div class="modal-body">
    <div class="row">
        @if ($id == 0)
            <div class="form-group col-md-12">
                ...
                <div class="text-xs mt-1">
                    {{ __('Create job application.') }} <a href="{{ route('interview-schedule.index') }}"><b>{{ __('Click here') }}</b></a>
                </div>
            </div>
        @endif
        <div class="form-group col-md-12">
        ...
        <div class="form-group col-md-6">
            ...
            <div class="text-xs mt-1">
                {{ __('Create salary type.') }} <a href="{{ route('paysliptype.index') }}"><b>{{ __('Click here') }}</b></a>
            </div>
        </div>
        <div class="form-group col-md-6">
