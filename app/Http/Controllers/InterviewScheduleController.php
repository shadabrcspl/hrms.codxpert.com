...
$jobonboard=JobOnBoard::where('status','!=','cancel')->pluck('application')->all();
$fixedinterview = LocalInterviewSchedule::pluck('candidate')->all();
$mergedArray = array_merge($jobonboard, $fixedinterview);
$candidates = JobApplication::where('created_by', \Auth::user()->creatorId())
->where('is_employee','!=','1')
