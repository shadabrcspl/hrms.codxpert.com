...
class EmployeeController extends Controller
{
    ...
    public function create()
    {
        if (\Auth::user()->can('Create Employee')) {
            ...
            return view('employee.create', compact('employees', 'employeesId', 'departments', 'designations', 'documents', 'branches', 'company_settings', 'shiftType'));
        } else {
            return redirect()->back()->with('error', __('Permission denied.'));
        }
    }
    ...
    public function edit($id)
    {
        ...
        if (\Auth::user()->can('Edit Employee')) {
            ...
            return view('employee.edit', compact('employee', 'employeesId', 'branches', 'departments', 'designations', 'documents', 'shiftType'));
        } else {
            return redirect()->back()->with('error', __('Permission denied.'));
        }
    }
