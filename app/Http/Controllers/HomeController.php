    ...
    public function index()
    {
        ...
        if (Auth::check()) {
            ...
            if ($user->type == 'employee') {
                ...
                // dd(Utility::getValByName('company_start_time'));
                $officeTime['startTime'] = Auth::user()->employee->shift_type === 'day' ? '00:00' : '12:00';
                // dd(Utility::getValByName('company_end_time'));
                $officeTime['endTime']   = Auth::user()->employee->shift_type === 'day' ? '23:59' : '11:59';
